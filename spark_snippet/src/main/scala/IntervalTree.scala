...
class IntervalTree[T](head: intervalTree.Node[T], intervals: List[Interval[T]]) {
  ...
  /**
    ...
    */
  def +(i: Interval[T]): intervalTree.IntervalTree[T] =
    new intervalTree.IntervalTree[T](intervalTree.Node[T](i :: intervals), i :: intervals)
  ...
  /**
    ...
    * @return an IntervalTree instance
    */
  def ++(seq: Seq[Interval[T]]): intervalTree.IntervalTree[T] =
    new intervalTree.IntervalTree[T](intervalTree.Node[T](seq ++ intervals), seq.toList ::: intervals)
  ...
  /**
    ...
    * @return an IntervalTree instance
    */
  def +(start: Long, end: Long, data: T): intervalTree.IntervalTree[T] = {
    val interval = new Interval[T](start, end, data)
    new intervalTree.IntervalTree[T](intervalTree.Node[T](interval :: intervals), interval :: intervals)
  }
}
...
object IntervalTree {
  ...
  /**
    ...
    * @return an IntervalTree instance
    */
  def empty[T]: intervalTree.IntervalTree[T] = new intervalTree.IntervalTree[T](intervalTree.Node.empty, List.empty)
  ...
  /**
    ...
    * @return an IntervalTree instance
    */
  def apply[T](): intervalTree.IntervalTree[T] = new intervalTree.IntervalTree[T](intervalTree.Node.empty, List.empty)
  ...
  /**
    ...
    * @return an IntervalTree instance
    */
  def apply[T](intervals: List[Interval[T]]): intervalTree.IntervalTree[T] =
    new intervalTree.IntervalTree[T](intervalTree.Node(intervals), intervals)
}
